...
import JobByCategory from '../Home/JobByCategory';
import PopularJobSearches from './PopularJobSearches';
import AutoSuggestedLocationForJob from './AutoSuggestedLocationForJob';
  ...
  return (
    <>
      <Box sx={{ width: '100%', display: "flex", justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }} >
        ...
        {/* Filter */}
        <Box sx={{ width: '100%', overflowX: 'auto', display: "flex", justifyContent: 'center', alignItems: 'center', borderBottom: '1px solid #d6d6dc', }} >
        ...
        <Container maxWidth='lg' sx={{ display: "flex", justifyContent: 'center', alignItems: 'start', flexDirection: 'column' }} >
          <JobByCategory />
          {
            JobTitle === 'Driver & Delivery' || JobTitle === 'Chef & Cook' || JobTitle === 'Construction & Trades' ?
              <AllJob /> : <Box sx={{ width: '100%', display: "flex", justifyContent: 'center', alignItems: 'start', flexDirection: 'column', pt: 4 }} >
                <Typography variant='h2' sx={{ fontSize: '28px', lineHeight: '36px', fontFamily: 'GraphikBold', color: '#29293d' }} >
                  No Results
                </Typography>
                <Typography variant='h2' sx={{ fontSize: '18px', lineHeight: '24px', fontFamily: 'GraphikRegular', color: '#29293d', mt: 1.5 }} >
                  No <Box component={'span'} sx={{ fontFamily: 'GraphikSemiboldItalic', fontSize: '18px', lineHeight: '24px', }} >"{JobTitle}"</Box> jobs found
                </Typography>
              </Box>
          }

          <Box sx={{ width: '100%', display: "flex", justifyContent: 'center', alignItems: 'center', flexDirection: { md: 'row', xs: 'column' }, my: { md: 8, xs: 4 } }} >
            <Box sx={{ width: { md: '50%', xs: '100%', } }} >
              <PopularJobSearches />
            </Box>
            <Box sx={{ width: { md: '50%', xs: '100%' }, mt: { md: 0, xs: 4 } }} >
              <AutoSuggestedLocationForJob />
            </Box>
          </Box>
        </Container>
      </Box>
