              ...
              <Grid item xs={12} md={3}>
                ...
                >
                  <FormControl sx={{ minWidth: 150, mb: 3 }} size="small">
                    ...
                    >
                      <LanguageIcon sx={{ mr: "4px" }} /> Language
                    </InputLabel>
                    <Select
                  ...
                  >
                    <AnchorLink href="" sx={{ mr: 2 }}>
                      <Image
                        src={"/pictures/home/fb-footer.svg"}
                        width={40}
                        height={40}
                        objectFit={"contain"}
                        alt={"icon"}
                    ...
                    <AnchorLink href="" sx={{ mr: 2 }}>
                      <Image
                        src={"/pictures/home/twitter-footer.svg"}
                        width={40}
                        height={40}
                        objectFit={"contain"}
                        alt={"icon"}
                    ...
                    <AnchorLink href="" sx={{ mr: 2 }}>
                      <Image
                        src={"/pictures/home/instagram-footer.svg"}
                        width={40}
                        height={40}
                        objectFit={"contain"}
                        alt={"icon"}
                    ...
                    <AnchorLink href="">
                      <Image
                        src={"/pictures/home/linkedin-footer.svg"}
                        width={40}
                        height={40}
                        objectFit={"contain"}
                        alt={"icon"}
                  ...
                  >
                    <AnchorLink href="" sx={{ mr: 2 }}>
                      <Image
                        src={"/pictures/home/app-store-badge-en.svg"}
                        width={128}
                        height={56}
                        objectFit={"contain"}
                        alt={"icon"}
                    ...
                    <AnchorLink href="">
                      <Image
                        src={"/pictures/home/google-play-badge-en.png"}
                        width={142}
                        height={56}
                        objectFit={"contain"}
                        alt={"icon"}
