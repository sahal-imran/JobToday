...
function Card_Bottom({Title, subTitle, Button_text}) {
    return (
        <>
            <Box sx={{ backgroundColor: '#fbfbfb', py: { md: 12, xs: 6 } }} >
                <Container maxWidth='lg' sx={{ m: 'auto', display: "flex", justifyContent: 'center', alignItems: 'center', flexDirection: { md: 'row', xs: "column" } }}>
                    ...
                    <Box sx={{ width: { md: '45%', xs: '100%' }, height: { md: '400px', xs: '300px' }, position: 'relative' }} >
                        <Image src={'/pictures/hire/hire3xa.png'} layout='fill' objectFit='contain' />
                        <Box sx={{ position: 'absolute', width: { md: '200px', xs: '120px' }, height: { md: '300px', xs: '220px' }, right: '10px', bottom: 0 }} >
                            <Image src={'/pictures/hire/Chat.png'} layout='fill' objectFit='contain' />
                        </Box>
                    </Box>
