...
function JobByCategory() {
    ...
    return (
        <>
            <Box sx={router.pathname === '/country' ? { width: '100%', py: 8, display: "flex", justifyContent: 'center', alignItems: 'center' } : { width: '100%', mt: 3, display: "flex", justifyContent: 'center', alignItems: 'center' }} >
                <Container maxWidth='lg' sx={{ display: "flex", justifyContent: 'center', alignItems: 'start', flexDirection: 'column' }} className={router.pathname === '/country' ? '' : 'padd-0'} >
                    <Typography variant='h2' sx={router.pathname === '/country' ? { fontSize: '28px', lineHeight: '36px', fontFamily: 'GraphikSemiBold', color: '#29293d',mb:4 } : {display:'none'} } >
                        Jobs by categories in UK
                    </Typography>
                    <Box sx={{ width: '100%', display: "flex", justifyContent: 'start', alignItems: 'center', flexWrap: 'wrap'}} >
                        {
                            ShowMore(Show_more).map((category, index) => {
                                return <Link key={index} href={`/country/${category.Name}`} >
                                    <AnchorLink sx={{
                                        ...
                                        }, display: "flex", justifyContent: 'center', alignItems: 'center', mr: 1, mt: 2,cursor:'pointer'
                                    }} >
