                    ...
                    <Box sx={{ width: '100%', display: "flex", justifyContent: 'space-between', alignItems: 'center', }} >
                        <Box sx={{ display: "flex", justifyContent: 'center', alignItems: 'start', flexDirection: 'column' }} >
                            <Typography variant='h2' sx={{ fontSize: '28px', lineHeight: '36px', fontFamily: 'GraphikBold', color: '#29293d' }} >
                                {
                                    router.pathname === '/country' ? `Popular job locations for ${'UK'}` : "Popular job locations"
                                }
                            </Typography>
                                ...
                                Cities.map((city) => {
                                    return <Grid key={city.id} item xs={6} md={3}>
                                        <Box sx={{ width: '100%', display: "flex", justifyContent: 'start', alignItems: 'center' }} >
                                            <Link href='' >
                                                <AnchorLink sx={router.pathname === '/country' ? { fontSize: '18px', lineHeight: '22px', fontFamily: 'GraphikRegular', color: '#29293d', textDecoration: 'none', textTransform: 'capitalize', cursor: 'pointer' } : { fontSize: '18px', lineHeight: '22px', fontFamily: 'GraphikRegular', color: '#2252c7', textDecoration: 'none', textTransform: 'capitalize', cursor: 'pointer' }} >
                                                    {city.city}
                                                </AnchorLink>
                                            </Link>
                                        </Box>
