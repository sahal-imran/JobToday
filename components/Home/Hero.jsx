      ...
      >
        ...
        >
          <img
            ...
            src="/pictures/home/small-bg.jpg"
            alt="bg"
          />
        </Box>
        {/* Top bar */}
        ...
        >
          ...
          >
            <Link href={"/hire"}>
              <AnchorLink sx={{ color: "white", textDecoration: "none",mr:2 }}>
                <Button
                  variant="contained"
                  sx={{
                    px: 2,
            ...
            <Link href={"/blog"}>
              <AnchorLink sx={{ color: "white", textDecoration: "none" }}>
                <Button
                  variant="contained"
                  sx={{
                    px: 2,
        ...
        >
          <Typography
            ...
            sx={{
              ...
              mb: 4,
              textShadow:
                "0px 2px 3px rgb(0 0 0 / 40%), 0px 4px 7px rgb(0 0 0 / 10%), 0px 9px 12px rgb(0 0 0 / 10%)",
              alignSelf: "start",
              ml: 2,
            }}
          >
          ...
          <Box
            sx={{
              ...
              borderRadius: "12px",
              boxShadow:
                "0 2px 20px rgb(0 0 0 / 30%), 0 2px 10px rgb(0 0 0 / 22%)",
        ...
        >
          <Box component={"span"} sx={{ color: "#000", cursor: "auto", mr: 1 }}>
            Are you a business?
          </Box>
          Post a job and hire
        </AnchorLink>
